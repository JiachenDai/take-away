...
public class UserController{
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(paramType = "path", name = "pageSize", value = "每页数据的大小", required = true, dataType = "Integer")
    })
    ...
    public PageVO<OperatorUser> findPageVO(@PathVariable("page") int pageNum,
                                           @PathVariable("pageSize") int pageSize){
        int i = 1 / 0;
        IPage<OperatorUser> page = operatorUserService.page(new Page<OperatorUser>(pageNum,pageSize));
